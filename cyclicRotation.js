...
function cyclicRotation(arr, rotation){
    ...
    //take the step for each integer up to K
    // and place as first item in array

    for (i = 0; i<rotation ; i++){
    	//remove last item in array and store as variable
    	var popped = arr.pop();
    	//add stored variable as first item in arracy	
    	arr.unshift(popped);
    }
